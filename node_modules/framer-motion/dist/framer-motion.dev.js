(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var mixArray = function (from, to) {
        ...
        var blendValue = from.map(function (fromThis, i) { return getMixer$1(fromThis, to[i]); });
        return function (v) {
            for (var i = 0; i < numValues; i++) {
    ...
    function inertia(_a) {
        ...
        function startAnimation(options) {
            ...
            currentAnimation = animate$1(__assign(__assign({}, options), { driver: driver, onUpdate: function (v) {
                    var _a;
    ...
    function AnimateLayoutContextProvider(props) {
        ...
        return React__namespace.createElement(Animate, __assign({}, props, { safeToRemove: safeToRemove }));
    }
    ...
    function MeasureContextProvider(props) {
        ...
        return (React__default['default'].createElement(Measure, __assign({}, props, { syncLayout: syncLayout, framerSyncLayout: framerSyncLayout })));
    }
